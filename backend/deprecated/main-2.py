...
choice = 4
stockChoice = stockList[choice]
stockDate = startList[choice]
...
timestamp = time.time()
data = {
    "previousCloseReal": prevCloseReal,
...
print(f"\n\nSuccessfully uploaded data to firebase storage and rtdb on {todayDate}.\n\n")